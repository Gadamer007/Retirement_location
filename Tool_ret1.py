...
if selected_vars:
    ...
    for var in selected_vars:
        max_category = sliders[var]  # Slider value
...
# Ensure grid lines are dashed
    # Ensure grid lines are dashed

    # Ensure grid lines are dashed
    fig_scatter.update_xaxes(
        showgrid=True, gridcolor='rgba(255, 255, 255, 0.3)', gridwidth=1,
        zeroline=True, zerolinecolor='white', zerolinewidth=1  # White zero line
    )
...
# Apply dashed grid lines to the entire layout
    fig_scatter.update_layout(
