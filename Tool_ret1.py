...
st.markdown("### Instructions for Using the Tool")
st.markdown("""
...
if selected_vars:
    ...
    fig_scatter.update_layout(
        ...
        xaxis=dict(linecolor='white', tickfont=dict(color='white'), showgrid=True, gridcolor='rgba(255, 255, 255, 0.3)', gridwidth=1, griddash="dash"),
        yaxis=dict(linecolor='white', tickfont=dict(color='white'), showgrid=True, gridcolor='rgba(255, 255, 255, 0.3)', gridwidth=1, griddash="dash"),
